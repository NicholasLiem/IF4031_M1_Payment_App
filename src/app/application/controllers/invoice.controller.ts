...
export class InvoiceController {
    ...
    async createInvoice(req: Request, res: Response) {
        try {
            const { booking_id, event_id, customer_id} = CreateInvoiceSchema.parse(req.body);

            const createdInvoice = await this.invoiceService.createInvoice(booking_id, event_id, customer_id);
